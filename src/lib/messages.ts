...
export const MESSAGES = {
  ...
  "nav.activityAria": { ja: "新しいお知らせ{n}件", vi: "{n} thông báo mới", en: "{n} new notifications" },
  "nav.menu": { ja: "メニュー", vi: "Menu", en: "Menu" },
  ...
  "game.other": { ja: "その他", vi: "Sản phẩm khác", en: "Other" },
  ...
  "home.tabOther": { ja: "その他", vi: "Khác", en: "Other" },
  ...
  "bon.selectOther": { ja: "募集する商品", vi: "Sản phẩm cần gom", en: "Product to buy" },
  ...
  "profile.trustScore": { ja: "トラストスコア", vi: "Điểm tin cậy", en: "Trust Score" },
  "profile.trustScoreHint": {
    ja: "取引実績・評価・アカウント歴・違反履歴から自動算出（0〜100）",
  ...
  "profile.tier.bronze": { ja: "🥉 ブロンズトレーナー", vi: "🥉 Bronze Trainer", en: "🥉 Bronze Trainer" },
  "profile.tier.silver": { ja: "🥈 シルバートレーナー", vi: "🥈 Silver Trainer", en: "🥈 Silver Trainer" },
  "profile.tier.gold": { ja: "🥇 ゴールドトレーナー", vi: "🥇 Gold Trainer", en: "🥇 Gold Trainer" },
  "profile.tier.platinum": { ja: "💎 プラチナトレーナー", vi: "💎 Platinum Trainer", en: "💎 Platinum Trainer" },
  "profile.tier.master": { ja: "👑 マスタートレーナー", vi: "👑 Master Trainer", en: "👑 Master Trainer" },
  "profile.tier.legendary": { ja: "🌈 レジェンドトレーナー", vi: "🌈 Legendary Trainer", en: "🌈 Legendary Trainer" },
  "profile.stats.title": { ja: "取引実績", vi: "Thống kê giao dịch", en: "Trading statistics" },
  "profile.stats.closed": { ja: "成立取引", vi: "Giao dịch hoàn tất", en: "Completed trades" },
  "profile.stats.partners": { ja: "取引相手数", vi: "Số đối tác", en: "Trade partners" },
  "profile.stats.completion": { ja: "完了率", vi: "Tỷ lệ hoàn thành", en: "Completion rate" },
  "profile.stats.cancelled": { ja: "キャンセル", vi: "Đã hủy", en: "Cancelled" },
  "profile.badges.title": { ja: "バッジ", vi: "Huy hiệu", en: "Badges" },
  "profile.badges.empty": {
    ja: "まだバッジがありません。取引を重ねて獲得しましょう。",
    vi: "Chưa có huy hiệu nào. Giao dịch thêm để nhận nhé.",
    en: "No badges yet. Keep trading to earn them.",
  },
  "badge.trades10": { ja: "🏆 取引10件", vi: "🏆 10 giao dịch", en: "🏆 10 Trades" },
  "badge.trades100": { ja: "🏆 取引100件", vi: "🏆 100 giao dịch", en: "🏆 100 Trades" },
  "badge.trades500": { ja: "🏆 取引500件", vi: "🏆 500 giao dịch", en: "🏆 500 Trades" },
  "badge.topSeller": { ja: "⭐ トップセラー", vi: "⭐ Top Seller", en: "⭐ Top Seller" },
  "badge.trustedTrader": { ja: "🛡 信頼トレーダー", vi: "🛡 Trader uy tín", en: "🛡 Trusted Trader" },
  "badge.perfectRating": { ja: "🎯 パーフェクト評価", vi: "🎯 Đánh giá tuyệt đối", en: "🎯 Perfect Rating" },
  "badge.noReport": { ja: "🔥 通報ゼロ", vi: "🔥 Không vi phạm", en: "🔥 No Report" },
  "badge.oneYear": { ja: "🎂 利用1年", vi: "🎂 Thành viên 1 năm", en: "🎂 One Year Member" },
  "profile.reviews.title": { ja: "最近の評価", vi: "Đánh giá gần đây", en: "Recent reviews" },
  "profile.reviews.empty": {
    ja: "まだ評価がありません。",
    vi: "Chưa có đánh giá nào.",
    en: "No reviews yet.",
  },
  "profile.listings.title": { ja: "出品中", vi: "Đang bán", en: "Active listings" },
  "profile.listings.empty": {
    ja: "現在出品中の商品はありません。",
    vi: "Hiện không có tin đang bán.",
    en: "No active listings.",
  },
  "profile.safety.title": { ja: "Trust & Safety", vi: "Trust & Safety", en: "Trust & Safety" },
  ...
  "profile.safety.yellow": {
    ja: "🟡 審査中の通報があります。取引前に情報をよくご確認ください（違反が確定したわけではありません）。",
  ...
  "profile.safety.red": {
    ja: "🔴 規約違反が確認されたアカウントです（確認済み{n}件）。取引は慎重にご判断ください。",
  ...
  "trade.safetyWarnYellow": {
    ja: "🟡 相手に審査中の通報があります。取引内容をよくご確認ください。",
  ...
  "trade.safetyWarnRed": {
    ja: "🔴 相手は規約違反が確認されたアカウントです（{n}件・トラストスコア{score}）。続行は自己責任でご判断ください。",
